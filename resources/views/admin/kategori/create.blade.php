<x-app-shell title="Tambah Kategori" page="Kategori" 
    :menu="[
    ...
    <div class="mx-auto max-w-xl space-y-6">
        <div data-anim>
            <h1 class="text-xl font-semibold tracking-tight lg:text-2xl">Tambah Kategori</h1>
            <p class="mt-1 text-sm text-muted">Buat kategori baru untuk mengelompokkan produk.</p>
        </div>

        <form data-anim method="POST" action="{{ route('admin.kategori.store') }}" class="panel p-6">
            @csrf
