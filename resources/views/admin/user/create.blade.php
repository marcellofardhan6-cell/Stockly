<x-app-shell title="Tambah User" page="User" 
    :menu="[
    ...
    <div class="mx-auto max-w-2xl space-y-6">
        <div data-anim>
            ...
            <h1 class="page-title mt-1 text-2xl font-semibold tracking-tight lg:text-3xl">Tambah User</h1>
            <p class="mt-1 text-sm text-muted">Buat akun admin atau kasir baru.</p>
        </div>

        <form data-anim method="POST" action="{{ route('admin.user.store') }}" class="panel p-6">
            @csrf
